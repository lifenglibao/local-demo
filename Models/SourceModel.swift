...
class SourceModel {
    ...
    static func loadHotModels() -> Array<SourceModel>{
    ...
    static func loadFavoriteModels() -> Array<SourceModel>{
        ...
        m10.id = 10
        m10.name = "吃喝玩乐"
        m10.imgName = "icn_mart"
        m10.isAvailable = true
        modelList.append(m10)
